...
/**
 * Computes again the dates of a poll which activity has been scheduled, once
 * that activity is effectively published, so that the poll runs its whole
 * chosen duration from its publication
 */
@Component
